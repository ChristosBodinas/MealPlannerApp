...
public class FoodTestFixtures {
    ...
    public static Food.FoodBuilder defaultFood() {
        ...
        Set<VendorData> defaultVendors = new HashSet<>(Set.of(
                new VendorData(DEFAULT_VENDOR_NAME_1, DEFAULT_PURCHASE_PRICE_1, DEFAULT_PURCHASE_GRAMS_1),
                new VendorData(DEFAULT_VENDOR_NAME_2, DEFAULT_PURCHASE_PRICE_2, DEFAULT_PURCHASE_GRAMS_2)
        ));
