...
public class FoodTestFixtures {
    ...
    private static final String DEFAULT_NAME = "Chicken";
    private static final String DEFAULT_BRAND = "MyFood";
    ...
    public static Food.FoodBuilder defaultFood() {
        Set<FoodUnit> defaultUnits = new HashSet<>(Set.of(
                new FoodUnit(DEFAULT_UNIT_NAME_1, DEFAULT_UNIT_GRAMS_1),
                new FoodUnit(DEFAULT_UNIT_NAME_2, DEFAULT_UNIT_GRAMS_2)
        ));

        Set<FoodPrice> defaultPrices = new HashSet<>(Set.of(
                new FoodPrice(DEFAULT_VENDOR_NAME_1, DEFAULT_PURCHASE_PRICE_1, DEFAULT_PURCHASE_GRAMS_1),
                new FoodPrice(DEFAULT_VENDOR_NAME_2, DEFAULT_PURCHASE_PRICE_2, DEFAULT_PURCHASE_GRAMS_2)
        ));
    ...
    public static FoodRequest.FoodRequestBuilder defaultFoodRequest() {
        ...
        Set<PriceRequest> defaultPrices = new HashSet<>(Set.of(
                new PriceRequest(DEFAULT_VENDOR_NAME_1, DEFAULT_PURCHASE_PRICE_1, DEFAULT_PURCHASE_GRAMS_1),
                new PriceRequest(DEFAULT_VENDOR_NAME_2, DEFAULT_PURCHASE_PRICE_2, DEFAULT_PURCHASE_GRAMS_2)
        ));
